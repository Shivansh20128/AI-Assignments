...
def unform_cost_search_algo(road_map, source, destination):
    ...
    while priority_queue:
        ...
        for connected_city in road_map[current_city]:
            better_path = shortest_distance_paths[current_city] + road_map[current_city][connected_city]['distance'] + inadmissible_heuristic(current_city,road_map)
            if better_path < shortest_distance_paths[connected_city]:
                shortest_distance_paths[connected_city] = better_path - inadmissible_heuristic(current_city,road_map)
...
def inadmissible_heuristic(city, road_map):
    return len(road_map[city])
